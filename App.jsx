            ...
            <div className="px-5 pt-5">
              ...
              <div className="bg-neutral-900 rounded-2xl p-5 mb-5 border border-neutral-800">
                <div className="grid grid-cols-2 gap-4">
                  <StepperField label="kg" value={weight} step={0.25} min={0} onChange={setWeight} />
                  <StepperField label="Wdh." value={reps} step={1} min={1} onChange={setReps} integer />
                </div>
                <button
                  onClick={addSet}
  ...
  return (
    <div className="bg-neutral-950 rounded-xl p-3 flex flex-col items-center">
      ...
      <input
        ...
        className="text-[28px] font-bold tabular-nums leading-none mb-3 bg-transparent text-center w-full outline-none focus:text-orange-400 no-spinner"
      />
