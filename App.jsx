...
export default function App() {
  ...
  const totalDraftSets = Object.values(draftEntries).reduce((sum, arr) => sum + arr.length, 0);
                ...
                <>
                  ...
                  {totalDraftSets > 0 && (
                    <button
                      ...
                      className="mt-2 w-full bg-orange-500 text-neutral-950 rounded-xl py-3.5 text-[14px] font-bold active:bg-orange-400 transition-colors"
                    >
